...
- 第三方中转站需要完整 Chat Completions 地址：`https://api.fishxcode.com/v1/chat/completions`。
:::
...
优先检查 `url`。FishXCode 第三方模型配置应使用完整地址 `https://api.fishxcode.com/v1/chat/completions`。
