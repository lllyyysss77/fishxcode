...
Si vous renseignez une Base URL, utilisez `https://api.fishxcode.com/v1`. Si vous renseignez une URL complète, utilisez `https://api.fishxcode.com/v1/chat/completions`.
